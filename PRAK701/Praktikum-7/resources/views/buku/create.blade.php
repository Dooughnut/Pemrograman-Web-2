...
<div class="max-w-3xl mx-auto w-full">
    ...
    <div class="bg-white py-8 px-6 shadow-xl rounded-xl border border-gray-100">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Tambah Data Buku</h2>
        ...
        <form action="{{ route('buku.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="number" name="tahun_terbit" id="tahun_terbit" value="{{ old('tahun_terbit') }}" required min="1801" max="2023"
                        class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
